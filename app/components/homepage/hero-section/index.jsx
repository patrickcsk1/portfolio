...
function HeroSection() {
  return (
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12 bg-[url('/hero.svg')] bg-cover bg-center bg-no-repeat">
        ...
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              target="_blank no-referrer no-opener noreferrer"
